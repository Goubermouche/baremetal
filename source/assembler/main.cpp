...
auto run_tests() -> test_result {
	...
	TEST_INST("49c787ffff000080ffffff"  , mov(mem64::ptr(r15, 0xFFFF), -128)       );
	...
	TEST_INST("49c787ffff000000000000"  , mov(mem64::ptr(r15, 0xFFFF), 0)          );
	TEST_INST("49c787ffff0000ffffff7f"  , mov(mem64::ptr(r15, 0xFFFF), 2147483647) );
	TEST_INST("49c787ffff000000000080"  , mov(mem64::ptr(r15, 0xFFFF), -2147483648));
	TEST_INST("49c787ffff0000ff7f0000"  , mov(mem64::ptr(r15, 0xFFFF), 32767)      );
	TEST_INST("49c787ffff00000080ffff"  , mov(mem64::ptr(r15, 0xFFFF), -32768)     );
	TEST_INST("49c787ffff00007f000000"  , mov(mem64::ptr(r15, 0xFFFF), 127)        );
	TEST_INST("49c787ffff000080ffffff"  , mov(mem64::ptr(r15, 0xFFFF), -128)       );
	TEST_INST("48c780ffff000000000000"  , mov(mem64::ptr(rax, 0xFFFF), 0)          );
	TEST_INST("48c780ffff0000ffffff7f"  , mov(mem64::ptr(rax, 0xFFFF), 2147483647) );
	TEST_INST("48c780ffff000000000080"  , mov(mem64::ptr(rax, 0xFFFF), -2147483648));
	...
	TEST_INST("48c78424ffff00007f000000", mov(mem64::ptr(rsp, 0xFFFF), 127)        );
	TEST_INST("48c78424ffff000080ffffff", mov(mem64::ptr(rsp, 0xFFFF), -128)       );
	TEST_INST("49c786ffff000000000000"  , mov(mem64::ptr(r14, 0xFFFF), 0)          );
	TEST_INST("49c786ffff0000ffffff7f"  , mov(mem64::ptr(r14, 0xFFFF), 2147483647) );
	TEST_INST("49c786ffff000000000080"  , mov(mem64::ptr(r14, 0xFFFF), -2147483648));
	TEST_INST("49c786ffff0000ff7f0000"  , mov(mem64::ptr(r14, 0xFFFF), 32767)      );
	TEST_INST("49c786ffff00000080ffff"  , mov(mem64::ptr(r14, 0xFFFF), -32768)     );
	TEST_INST("49c786ffff00007f000000"  , mov(mem64::ptr(r14, 0xFFFF), 127)        );
	TEST_INST("49c786ffff000080ffffff"  , mov(mem64::ptr(r14, 0xFFFF), -128)       );
	...
	TEST_INST("49898fffff0000"          , mov(mem64::ptr(r15, 0xFFFF), rcx)        );
	TEST_INST("498997ffff0000"          , mov(mem64::ptr(r15, 0xFFFF), rdx)        );
	TEST_INST("49899fffff0000"          , mov(mem64::ptr(r15, 0xFFFF), rbx)        );
	TEST_INST("4d89bfffff0000"          , mov(mem64::ptr(r15, 0xFFFF), r15)        );
	TEST_INST("48898c24ffff0000"        , mov(mem64::ptr(rsp, 0xFFFF), rcx)        );
	TEST_INST("48899424ffff0000"        , mov(mem64::ptr(rsp, 0xFFFF), rdx)        );
	TEST_INST("48899c24ffff0000"        , mov(mem64::ptr(rsp, 0xFFFF), rbx)        );
	TEST_INST("4c89bc24ffff0000"        , mov(mem64::ptr(rsp, 0xFFFF), r15)        );
	TEST_INST("49898effff0000"          , mov(mem64::ptr(r14, 0xFFFF), rcx)        );
	TEST_INST("498996ffff0000"          , mov(mem64::ptr(r14, 0xFFFF), rdx)        );
	TEST_INST("49899effff0000"          , mov(mem64::ptr(r14, 0xFFFF), rbx)        );
	TEST_INST("4d89beffff0000"          , mov(mem64::ptr(r14, 0xFFFF), r15)        );
	TEST_INST("8a0c2500000000"          , mov(cl, mem8::absolute(0x0))             );
	TEST_INST("8a0c25ff000000"          , mov(cl, mem8::absolute(0xFF))            );
	TEST_INST("8a0c25ffff0000"          , mov(cl, mem8::absolute(0xFFFF))          );
	...
	TEST_INST("418a8fffff0000"          , mov(cl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a08"                    , mov(cl, mem8::ptr(rax, 0x0))             );
	TEST_INST("8a88ffff0000"            , mov(cl, mem8::ptr(rax, 0xFFFF))          );
	TEST_INST("418a8fffff0000"          , mov(cl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a88ffff0000"            , mov(cl, mem8::ptr(rax, 0xFFFF))          );
	...
	TEST_INST("418a8fffff0000"          , mov(cl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a8c24ffff0000"          , mov(cl, mem8::ptr(rsp, 0xFFFF))          );
	TEST_INST("418a8effff0000"          , mov(cl, mem8::ptr(r14, 0xFFFF))          );
	TEST_INST("8a142500000000"          , mov(dl, mem8::absolute(0x0))             );
	TEST_INST("8a1425ff000000"          , mov(dl, mem8::absolute(0xFF))            );
	TEST_INST("8a1425ffff0000"          , mov(dl, mem8::absolute(0xFFFF))          );
	...
	TEST_INST("418a97ffff0000"          , mov(dl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a10"                    , mov(dl, mem8::ptr(rax, 0x0))             );
	TEST_INST("8a90ffff0000"            , mov(dl, mem8::ptr(rax, 0xFFFF))          );
	TEST_INST("418a97ffff0000"          , mov(dl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a90ffff0000"            , mov(dl, mem8::ptr(rax, 0xFFFF))          );
	...
	TEST_INST("418a97ffff0000"          , mov(dl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a9424ffff0000"          , mov(dl, mem8::ptr(rsp, 0xFFFF))          );
	TEST_INST("418a96ffff0000"          , mov(dl, mem8::ptr(r14, 0xFFFF))          );
	TEST_INST("8a1c2500000000"          , mov(bl, mem8::absolute(0x0))             );
	TEST_INST("8a1c25ff000000"          , mov(bl, mem8::absolute(0xFF))            );
	TEST_INST("8a1c25ffff0000"          , mov(bl, mem8::absolute(0xFFFF))          );
	...
	TEST_INST("418a9fffff0000"          , mov(bl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a18"                    , mov(bl, mem8::ptr(rax, 0x0))             );
	TEST_INST("8a98ffff0000"            , mov(bl, mem8::ptr(rax, 0xFFFF))          );
	TEST_INST("418a9fffff0000"          , mov(bl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a98ffff0000"            , mov(bl, mem8::ptr(rax, 0xFFFF))          );
	...
	TEST_INST("418a9fffff0000"          , mov(bl, mem8::ptr(r15, 0xFFFF))          );
	TEST_INST("8a9c24ffff0000"          , mov(bl, mem8::ptr(rsp, 0xFFFF))          );
	TEST_INST("418a9effff0000"          , mov(bl, mem8::ptr(r14, 0xFFFF))          );
	TEST_INST("668b0c2500000000"        , mov(cx, mem16::absolute(0x0))            );
	TEST_INST("668b0c25ff000000"        , mov(cx, mem16::absolute(0xFF))           );
	TEST_INST("668b0c25ffff0000"        , mov(cx, mem16::absolute(0xFFFF))         );
	TEST_INST("668b0df9ffffff"          , mov(cx, mem16::ptr(rip, 0x0))            );
	TEST_INST("668b0df8000000"          , mov(cx, mem16::ptr(rip, 0xFF))           );
	TEST_INST("41c787ffff00007f000000"  , mov(mem32::ptr(r15, 0xFFFF), 127)        );
	TEST_INST("41c787ffff000080ffffff"  , mov(mem32::ptr(r15, 0xFFFF), -128)       );
	...
	TEST_INST("41c787ffff000000000000"  , mov(mem32::ptr(r15, 0xFFFF), 0)          );
	TEST_INST("41c787ffff0000ffffff7f"  , mov(mem32::ptr(r15, 0xFFFF), 2147483647) );
	TEST_INST("41c787ffff000000000080"  , mov(mem32::ptr(r15, 0xFFFF), -2147483648));
	TEST_INST("41c787ffff0000ff7f0000"  , mov(mem32::ptr(r15, 0xFFFF), 32767)      );
	TEST_INST("41c787ffff00000080ffff"  , mov(mem32::ptr(r15, 0xFFFF), -32768)     );
	TEST_INST("41c787ffff00007f000000"  , mov(mem32::ptr(r15, 0xFFFF), 127)        );
	TEST_INST("41c787ffff000080ffffff"  , mov(mem32::ptr(r15, 0xFFFF), -128)       );
	TEST_INST("c780ffff000000000000"    , mov(mem32::ptr(rax, 0xFFFF), 0)          );
	TEST_INST("c780ffff0000ffffff7f"    , mov(mem32::ptr(rax, 0xFFFF), 2147483647) );
	...
	TEST_INST("c78424ffff00007f000000"  , mov(mem32::ptr(rsp, 0xFFFF), 127)        );
	TEST_INST("c78424ffff000080ffffff"  , mov(mem32::ptr(rsp, 0xFFFF), -128)       );
	TEST_INST("41c786ffff000000000000"  , mov(mem32::ptr(r14, 0xFFFF), 0)          );
	TEST_INST("41c786ffff0000ffffff7f"  , mov(mem32::ptr(r14, 0xFFFF), 2147483647) );
	TEST_INST("41c786ffff000000000080"  , mov(mem32::ptr(r14, 0xFFFF), -2147483648));
	TEST_INST("41c786ffff0000ff7f0000"  , mov(mem32::ptr(r14, 0xFFFF), 32767)      );
	TEST_INST("41c786ffff00000080ffff"  , mov(mem32::ptr(r14, 0xFFFF), -32768)     );
	TEST_INST("41c786ffff00007f000000"  , mov(mem32::ptr(r14, 0xFFFF), 127)        );
	TEST_INST("41c786ffff000080ffffff"  , mov(mem32::ptr(r14, 0xFFFF), -128)       );
	...
	TEST_INST("880c2500000000"          , mov(mem8::absolute(0x0), cl)             );
	TEST_INST("88142500000000"          , mov(mem8::absolute(0x0), dl)             );
	TEST_INST("881c2500000000"          , mov(mem8::absolute(0x0), bl)             );
	TEST_INST("880c25ff000000"          , mov(mem8::absolute(0xFF), cl)            );
	TEST_INST("881425ff000000"          , mov(mem8::absolute(0xFF), dl)            );
	TEST_INST("881c25ff000000"          , mov(mem8::absolute(0xFF), bl)            );
	TEST_INST("880c25ffff0000"          , mov(mem8::absolute(0xFFFF), cl)          );
	TEST_INST("881425ffff0000"          , mov(mem8::absolute(0xFFFF), dl)          );
	TEST_INST("881c25ffff0000"          , mov(mem8::absolute(0xFFFF), bl)          );
	...
	TEST_INST("41888fffff0000"          , mov(mem8::ptr(r15, 0xFFFF), cl)          );
	TEST_INST("418897ffff0000"          , mov(mem8::ptr(r15, 0xFFFF), dl)          );
	TEST_INST("41889fffff0000"          , mov(mem8::ptr(r15, 0xFFFF), bl)          );
	TEST_INST("8808"                    , mov(mem8::ptr(rax, 0x0), cl)             );
	TEST_INST("8810"                    , mov(mem8::ptr(rax, 0x0), dl)             );
	TEST_INST("8818"                    , mov(mem8::ptr(rax, 0x0), bl)             );
	TEST_INST("8888ffff0000"            , mov(mem8::ptr(rax, 0xFFFF), cl)          );
	...
	TEST_INST("889424ffff0000"          , mov(mem8::ptr(rsp, 0xFFFF), dl)          );
	TEST_INST("889c24ffff0000"          , mov(mem8::ptr(rsp, 0xFFFF), bl)          );
	TEST_INST("41888effff0000"          , mov(mem8::ptr(r14, 0xFFFF), cl)          );
	TEST_INST("418896ffff0000"          , mov(mem8::ptr(r14, 0xFFFF), dl)          );
	TEST_INST("41889effff0000"          , mov(mem8::ptr(r14, 0xFFFF), bl)          );
	...
	TEST_INST("41c686ffff000000"        , mov(mem8::ptr(r14, 0xFFFF), 0)           );
	TEST_INST("41c686ffff00007f"        , mov(mem8::ptr(r14, 0xFFFF), 127)         );
	TEST_INST("41c686ffff000080"        , mov(mem8::ptr(r14, 0xFFFF), -128)        );
	TEST_INST("66c70425000000000000"    , mov(mem16::absolute(0x0), 0)             );
	TEST_INST("66c7042500000000ff7f"    , mov(mem16::absolute(0x0), 32767)         );
	TEST_INST("66c70425000000000080"    , mov(mem16::absolute(0x0), -32768)        );
	TEST_INST("66c70425000000007f00"    , mov(mem16::absolute(0x0), 127)           );
	TEST_INST("66c704250000000080ff"    , mov(mem16::absolute(0x0), -128)          );
	TEST_INST("66c70425ff0000000000"    , mov(mem16::absolute(0xFF), 0)            );
	TEST_INST("66c70425ff000000ff7f"    , mov(mem16::absolute(0xFF), 32767)        );
	TEST_INST("66c70425ff0000000080"    , mov(mem16::absolute(0xFF), -32768)       );
	TEST_INST("66c70425ff0000007f00"    , mov(mem16::absolute(0xFF), 127)          );
	TEST_INST("66c70425ff00000080ff"    , mov(mem16::absolute(0xFF), -128)         );
	TEST_INST("66c70425ffff00000000"    , mov(mem16::absolute(0xFFFF), 0)          );
	TEST_INST("66c70425ffff0000ff7f"    , mov(mem16::absolute(0xFFFF), 32767)      );
	TEST_INST("66c70425ffff00000080"    , mov(mem16::absolute(0xFFFF), -32768)     );
	TEST_INST("66c70425ffff00007f00"    , mov(mem16::absolute(0xFFFF), 127)        );
	TEST_INST("66c70425ffff000080ff"    , mov(mem16::absolute(0xFFFF), -128)       );
	...
	TEST_INST("6641c787ffff00000000"    , mov(mem16::ptr(r15, 0xFFFF), 0)          );
	TEST_INST("6641c787ffff0000ff7f"    , mov(mem16::ptr(r15, 0xFFFF), 32767)      );
	TEST_INST("6641c787ffff00000080"    , mov(mem16::ptr(r15, 0xFFFF), -32768)     );
	TEST_INST("6641c787ffff00007f00"    , mov(mem16::ptr(r15, 0xFFFF), 127)        );
	TEST_INST("6641c787ffff000080ff"    , mov(mem16::ptr(r15, 0xFFFF), -128)       );
	TEST_INST("66c7000000"              , mov(mem16::ptr(rax, 0x0), 0)             );
	TEST_INST("66c700ff7f"              , mov(mem16::ptr(rax, 0x0), 32767)         );
	TEST_INST("66c7000080"              , mov(mem16::ptr(rax, 0x0), -32768)        );
	TEST_INST("66c7007f00"              , mov(mem16::ptr(rax, 0x0), 127)           );
	...
	TEST_INST("41898effff0000"          , mov(mem32::ptr(r14, 0xFFFF), ecx)        );
	TEST_INST("418996ffff0000"          , mov(mem32::ptr(r14, 0xFFFF), edx)        );
	TEST_INST("41899effff0000"          , mov(mem32::ptr(r14, 0xFFFF), ebx)        );
	TEST_INST("4589beffff0000"          , mov(mem32::ptr(r14, 0xFFFF), r15d)       );
	...
	TEST_INST("48890c2500000000"        , mov(mem64::absolute(0x0), rcx)           );
	TEST_INST("4889142500000000"        , mov(mem64::absolute(0x0), rdx)           );
	TEST_INST("48891c2500000000"        , mov(mem64::absolute(0x0), rbx)           );
	TEST_INST("4c893c2500000000"        , mov(mem64::absolute(0x0), r15)           );
	TEST_INST("48890c25ff000000"        , mov(mem64::absolute(0xFF), rcx)          );
	TEST_INST("48891425ff000000"        , mov(mem64::absolute(0xFF), rdx)          );
	TEST_INST("48891c25ff000000"        , mov(mem64::absolute(0xFF), rbx)          );
	TEST_INST("4c893c25ff000000"        , mov(mem64::absolute(0xFF), r15)          );
	TEST_INST("48890c25ffff0000"        , mov(mem64::absolute(0xFFFF), rcx)        );
	TEST_INST("48891425ffff0000"        , mov(mem64::absolute(0xFFFF), rdx)        );
	TEST_INST("48891c25ffff0000"        , mov(mem64::absolute(0xFFFF), rbx)        );
	TEST_INST("4c893c25ffff0000"        , mov(mem64::absolute(0xFFFF), r15)        );
	...
	TEST_INST("488998ffff0000"          , mov(mem64::ptr(rax, 0xFFFF), rbx)        );
	TEST_INST("4c89b8ffff0000"          , mov(mem64::ptr(rax, 0xFFFF), r15)        );
	TEST_INST("48a1ffff000000000000"    , mov(rax, moff(0xFFFF))                   );
	TEST_INST("48a1ffffffff00000000"    , mov(rax, moff(0xFFFFFFFF))               );
	TEST_INST("48a1ffffffffffffffff"    , mov(rax, moff(0xFFFFFFFFFFFFFFFF))       );
	TEST_INST("a20000000000000000"      , mov(moff(0), al)                         );
	TEST_INST("a2ff00000000000000"      , mov(moff(0xFF), al)                      );
	TEST_INST("a2ffff000000000000"      , mov(moff(0xFFFF), al)                    );
	TEST_INST("a2ffffffff00000000"      , mov(moff(0xFFFFFFFF), al)                );
	TEST_INST("a2ffffffffffffffff"      , mov(moff(0xFFFFFFFFFFFFFFFF), al)        );
	TEST_INST("66a30000000000000000"    , mov(moff(0), ax)                         );
	TEST_INST("66a3ff00000000000000"    , mov(moff(0xFF), ax)                      );
	TEST_INST("66a3ffff000000000000"    , mov(moff(0xFFFF), ax)                    );
	TEST_INST("66a3ffffffff00000000"    , mov(moff(0xFFFFFFFF), ax)                );
	TEST_INST("66a3ffffffffffffffff"    , mov(moff(0xFFFFFFFFFFFFFFFF), ax)        );
	TEST_INST("a30000000000000000"      , mov(moff(0), eax)                        );
	TEST_INST("a3ff00000000000000"      , mov(moff(0xFF), eax)                     );
	TEST_INST("a3ffff000000000000"      , mov(moff(0xFFFF), eax)                   );
	TEST_INST("a3ffffffff00000000"      , mov(moff(0xFFFFFFFF), eax)               );
	TEST_INST("a3ffffffffffffffff"      , mov(moff(0xFFFFFFFFFFFFFFFF), eax)       );
	TEST_INST("48a30000000000000000"    , mov(moff(0), rax)                        );
	TEST_INST("48a3ff00000000000000"    , mov(moff(0xFF), rax)                     );
	TEST_INST("48a3ffff000000000000"    , mov(moff(0xFFFF), rax)                   );
	TEST_INST("48a3ffffffff00000000"    , mov(moff(0xFFFFFFFF), rax)               );
	TEST_INST("48a3ffffffffffffffff"    , mov(moff(0xFFFFFFFFFFFFFFFF), rax)       );
	...
	TEST_INST("66418b8fffff0000"        , mov(cx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b08"                  , mov(cx, mem16::ptr(rax, 0x0))            );
	TEST_INST("668b88ffff0000"          , mov(cx, mem16::ptr(rax, 0xFFFF))         );
	TEST_INST("66418b8fffff0000"        , mov(cx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b88ffff0000"          , mov(cx, mem16::ptr(rax, 0xFFFF))         );
	...
	TEST_INST("66418b8fffff0000"        , mov(cx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b8c24ffff0000"        , mov(cx, mem16::ptr(rsp, 0xFFFF))         );
	TEST_INST("66418b8effff0000"        , mov(cx, mem16::ptr(r14, 0xFFFF))         );
	TEST_INST("668b142500000000"        , mov(dx, mem16::absolute(0x0))            );
	TEST_INST("668b1425ff000000"        , mov(dx, mem16::absolute(0xFF))           );
	TEST_INST("668b1425ffff0000"        , mov(dx, mem16::absolute(0xFFFF))         );
	...
	TEST_INST("66418b97ffff0000"        , mov(dx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b10"                  , mov(dx, mem16::ptr(rax, 0x0))            );
	TEST_INST("668b90ffff0000"          , mov(dx, mem16::ptr(rax, 0xFFFF))         );
	TEST_INST("66418b97ffff0000"        , mov(dx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b90ffff0000"          , mov(dx, mem16::ptr(rax, 0xFFFF))         );
	...
	TEST_INST("66418b97ffff0000"        , mov(dx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b9424ffff0000"        , mov(dx, mem16::ptr(rsp, 0xFFFF))         );
	TEST_INST("66418b96ffff0000"        , mov(dx, mem16::ptr(r14, 0xFFFF))         );
	TEST_INST("668b1c2500000000"        , mov(bx, mem16::absolute(0x0))            );
	TEST_INST("668b1c25ff000000"        , mov(bx, mem16::absolute(0xFF))           );
	TEST_INST("668b1c25ffff0000"        , mov(bx, mem16::absolute(0xFFFF))         );
	...
	TEST_INST("66418b9fffff0000"        , mov(bx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b18"                  , mov(bx, mem16::ptr(rax, 0x0))            );
	TEST_INST("668b98ffff0000"          , mov(bx, mem16::ptr(rax, 0xFFFF))         );
	TEST_INST("66418b9fffff0000"        , mov(bx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b98ffff0000"          , mov(bx, mem16::ptr(rax, 0xFFFF))         );
	...
	TEST_INST("66418b9fffff0000"        , mov(bx, mem16::ptr(r15, 0xFFFF))         );
	TEST_INST("668b9c24ffff0000"        , mov(bx, mem16::ptr(rsp, 0xFFFF))         );
	TEST_INST("66418b9effff0000"        , mov(bx, mem16::ptr(r14, 0xFFFF))         );
	TEST_INST("66448b3c2500000000"      , mov(r15w, mem16::absolute(0x0))          );
	TEST_INST("66448b3c25ff000000"      , mov(r15w, mem16::absolute(0xFF))         );
	TEST_INST("66448b3c25ffff0000"      , mov(r15w, mem16::absolute(0xFFFF))       );
	...
	TEST_INST("66458bbfffff0000"        , mov(r15w, mem16::ptr(r15, 0xFFFF))       );
	TEST_INST("66448b38"                , mov(r15w, mem16::ptr(rax, 0x0))          );
	TEST_INST("66448bb8ffff0000"        , mov(r15w, mem16::ptr(rax, 0xFFFF))       );
	TEST_INST("66458bbfffff0000"        , mov(r15w, mem16::ptr(r15, 0xFFFF))       );
	TEST_INST("66448bb8ffff0000"        , mov(r15w, mem16::ptr(rax, 0xFFFF))       );
	...
	TEST_INST("66458bbfffff0000"        , mov(r15w, mem16::ptr(r15, 0xFFFF))       );
	TEST_INST("66448bbc24ffff0000"      , mov(r15w, mem16::ptr(rsp, 0xFFFF))       );
	TEST_INST("66458bbeffff0000"        , mov(r15w, mem16::ptr(r14, 0xFFFF))       );
	TEST_INST("8b0c2500000000"          , mov(ecx, mem32::absolute(0x0))           );
	TEST_INST("8b0c25ff000000"          , mov(ecx, mem32::absolute(0xFF))          );
	TEST_INST("8b0c25ffff0000"          , mov(ecx, mem32::absolute(0xFFFF))        );
	...
	TEST_INST("66c78424ffff00007f00"    , mov(mem16::ptr(rsp, 0xFFFF), 127)        );
	TEST_INST("66c78424ffff000080ff"    , mov(mem16::ptr(rsp, 0xFFFF), -128)       );
	TEST_INST("6641c786ffff00000000"    , mov(mem16::ptr(r14, 0xFFFF), 0)          );
	TEST_INST("6641c786ffff0000ff7f"    , mov(mem16::ptr(r14, 0xFFFF), 32767)      );
	TEST_INST("6641c786ffff00000080"    , mov(mem16::ptr(r14, 0xFFFF), -32768)     );
	TEST_INST("6641c786ffff00007f00"    , mov(mem16::ptr(r14, 0xFFFF), 127)        );
	TEST_INST("6641c786ffff000080ff"    , mov(mem16::ptr(r14, 0xFFFF), -128)       );
	TEST_INST("c704250000000000000000"  , mov(mem32::absolute(0x0), 0)             );
	TEST_INST("c7042500000000ffffff7f"  , mov(mem32::absolute(0x0), 2147483647)    );
	TEST_INST("c704250000000000000080"  , mov(mem32::absolute(0x0), -2147483648)   );
	TEST_INST("c7042500000000ff7f0000"  , mov(mem32::absolute(0x0), 32767)         );
	TEST_INST("c70425000000000080ffff"  , mov(mem32::absolute(0x0), -32768)        );
	TEST_INST("c70425000000007f000000"  , mov(mem32::absolute(0x0), 127)           );
	TEST_INST("c704250000000080ffffff"  , mov(mem32::absolute(0x0), -128)          );
	TEST_INST("c70425ff00000000000000"  , mov(mem32::absolute(0xFF), 0)            );
	TEST_INST("c70425ff000000ffffff7f"  , mov(mem32::absolute(0xFF), 2147483647)   );
	TEST_INST("c70425ff00000000000080"  , mov(mem32::absolute(0xFF), -2147483648)  );
	TEST_INST("c70425ff000000ff7f0000"  , mov(mem32::absolute(0xFF), 32767)        );
	TEST_INST("c70425ff0000000080ffff"  , mov(mem32::absolute(0xFF), -32768)       );
	TEST_INST("c70425ff0000007f000000"  , mov(mem32::absolute(0xFF), 127)          );
	TEST_INST("c70425ff00000080ffffff"  , mov(mem32::absolute(0xFF), -128)         );
	TEST_INST("c70425ffff000000000000"  , mov(mem32::absolute(0xFFFF), 0)          );
	TEST_INST("c70425ffff0000ffffff7f"  , mov(mem32::absolute(0xFFFF), 2147483647) );
	TEST_INST("c70425ffff000000000080"  , mov(mem32::absolute(0xFFFF), -2147483648));
	TEST_INST("c70425ffff0000ff7f0000"  , mov(mem32::absolute(0xFFFF), 32767)      );
	TEST_INST("c70425ffff00000080ffff"  , mov(mem32::absolute(0xFFFF), -32768)     );
	TEST_INST("c70425ffff00007f000000"  , mov(mem32::absolute(0xFFFF), 127)        );
	TEST_INST("c70425ffff000080ffffff"  , mov(mem32::absolute(0xFFFF), -128)       );
	...
	TEST_INST("498b8fffff0000"          , mov(rcx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b8c24ffff0000"        , mov(rcx, mem64::ptr(rsp, 0xFFFF))        );
	TEST_INST("498b8effff0000"          , mov(rcx, mem64::ptr(r14, 0xFFFF))        );
	TEST_INST("488b142500000000"        , mov(rdx, mem64::absolute(0x0))           );
	TEST_INST("488b1425ff000000"        , mov(rdx, mem64::absolute(0xFF))          );
	TEST_INST("488b1425ffff0000"        , mov(rdx, mem64::absolute(0xFFFF))        );
	...
	TEST_INST("498b97ffff0000"          , mov(rdx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b10"                  , mov(rdx, mem64::ptr(rax, 0x0))           );
	TEST_INST("488b90ffff0000"          , mov(rdx, mem64::ptr(rax, 0xFFFF))        );
	TEST_INST("498b97ffff0000"          , mov(rdx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b90ffff0000"          , mov(rdx, mem64::ptr(rax, 0xFFFF))        );
	...
	TEST_INST("498b97ffff0000"          , mov(rdx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b9424ffff0000"        , mov(rdx, mem64::ptr(rsp, 0xFFFF))        );
	TEST_INST("498b96ffff0000"          , mov(rdx, mem64::ptr(r14, 0xFFFF))        );
	TEST_INST("488b1c2500000000"        , mov(rbx, mem64::absolute(0x0))           );
	TEST_INST("488b1c25ff000000"        , mov(rbx, mem64::absolute(0xFF))          );
	TEST_INST("488b1c25ffff0000"        , mov(rbx, mem64::absolute(0xFFFF))        );
	...
	TEST_INST("498b9fffff0000"          , mov(rbx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b18"                  , mov(rbx, mem64::ptr(rax, 0x0))           );
	TEST_INST("488b98ffff0000"          , mov(rbx, mem64::ptr(rax, 0xFFFF))        );
	TEST_INST("498b9fffff0000"          , mov(rbx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b98ffff0000"          , mov(rbx, mem64::ptr(rax, 0xFFFF))        );
	...
	TEST_INST("498b9fffff0000"          , mov(rbx, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("488b9c24ffff0000"        , mov(rbx, mem64::ptr(rsp, 0xFFFF))        );
	TEST_INST("498b9effff0000"          , mov(rbx, mem64::ptr(r14, 0xFFFF))        );
	TEST_INST("4c8b3c2500000000"        , mov(r15, mem64::absolute(0x0))           );
	TEST_INST("4c8b3c25ff000000"        , mov(r15, mem64::absolute(0xFF))          );
	TEST_INST("4c8b3c25ffff0000"        , mov(r15, mem64::absolute(0xFFFF))        );
	...
	TEST_INST("4d8bbfffff0000"          , mov(r15, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("4c8b38"                  , mov(r15, mem64::ptr(rax, 0x0))           );
	TEST_INST("4c8bb8ffff0000"          , mov(r15, mem64::ptr(rax, 0xFFFF))        );
	TEST_INST("4d8bbfffff0000"          , mov(r15, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("4c8bb8ffff0000"          , mov(r15, mem64::ptr(rax, 0xFFFF))        );
	...
	TEST_INST("4d8bbfffff0000"          , mov(r15, mem64::ptr(r15, 0xFFFF))        );
	TEST_INST("4c8bbc24ffff0000"        , mov(r15, mem64::ptr(rsp, 0xFFFF))        );
	TEST_INST("4d8bbeffff0000"          , mov(r15, mem64::ptr(r14, 0xFFFF))        );
	TEST_INST("a00000000000000000"      , mov(al, moff(0))                         );
	TEST_INST("a0ff00000000000000"      , mov(al, moff(0xFF))                      );
	TEST_INST("a0ffff000000000000"      , mov(al, moff(0xFFFF))                    );
	TEST_INST("a0ffffffff00000000"      , mov(al, moff(0xFFFFFFFF))                );
	TEST_INST("a0ffffffffffffffff"      , mov(al, moff(0xFFFFFFFFFFFFFFFF))        );
	TEST_INST("66a10000000000000000"    , mov(ax, moff(0))                         );
	TEST_INST("66a1ff00000000000000"    , mov(ax, moff(0xFF))                      );
	TEST_INST("66a1ffff000000000000"    , mov(ax, moff(0xFFFF))                    );
	TEST_INST("66a1ffffffff00000000"    , mov(ax, moff(0xFFFFFFFF))                );
	TEST_INST("66a1ffffffffffffffff"    , mov(ax, moff(0xFFFFFFFFFFFFFFFF))        );
	TEST_INST("a10000000000000000"      , mov(eax, moff(0))                        );
	TEST_INST("a1ff00000000000000"      , mov(eax, moff(0xFF))                     );
	TEST_INST("a1ffff000000000000"      , mov(eax, moff(0xFFFF))                   );
	TEST_INST("a1ffffffff00000000"      , mov(eax, moff(0xFFFFFFFF))               );
	TEST_INST("a1ffffffffffffffff"      , mov(eax, moff(0xFFFFFFFFFFFFFFFF))       );
	TEST_INST("48a10000000000000000"    , mov(rax, moff(0))                        );
	TEST_INST("48a1ff00000000000000"    , mov(rax, moff(0xFF))                     );
	TEST_INST("66890c2500000000"        , mov(mem16::absolute(0x0), cx)            );
	TEST_INST("6689142500000000"        , mov(mem16::absolute(0x0), dx)            );
	TEST_INST("66891c2500000000"        , mov(mem16::absolute(0x0), bx)            );
	TEST_INST("6644893c2500000000"      , mov(mem16::absolute(0x0), r15w)          );
	TEST_INST("66890c25ff000000"        , mov(mem16::absolute(0xFF), cx)           );
	TEST_INST("66891425ff000000"        , mov(mem16::absolute(0xFF), dx)           );
	TEST_INST("66891c25ff000000"        , mov(mem16::absolute(0xFF), bx)           );
	TEST_INST("6644893c25ff000000"      , mov(mem16::absolute(0xFF), r15w)         );
	TEST_INST("66890c25ffff0000"        , mov(mem16::absolute(0xFFFF), cx)         );
	TEST_INST("66891425ffff0000"        , mov(mem16::absolute(0xFFFF), dx)         );
	TEST_INST("66891c25ffff0000"        , mov(mem16::absolute(0xFFFF), bx)         );
	TEST_INST("6644893c25ffff0000"      , mov(mem16::absolute(0xFFFF), r15w)       );
	...
	TEST_INST("6641898fffff0000"        , mov(mem16::ptr(r15, 0xFFFF), cx)         );
	TEST_INST("66418997ffff0000"        , mov(mem16::ptr(r15, 0xFFFF), dx)         );
	TEST_INST("6641899fffff0000"        , mov(mem16::ptr(r15, 0xFFFF), bx)         );
	TEST_INST("664589bfffff0000"        , mov(mem16::ptr(r15, 0xFFFF), r15w)       );
	TEST_INST("668908"                  , mov(mem16::ptr(rax, 0x0), cx)            );
	TEST_INST("668910"                  , mov(mem16::ptr(rax, 0x0), dx)            );
	TEST_INST("668918"                  , mov(mem16::ptr(rax, 0x0), bx)            );
	TEST_INST("66448938"                , mov(mem16::ptr(rax, 0x0), r15w)          );
	...
	TEST_INST("66899c24ffff0000"        , mov(mem16::ptr(rsp, 0xFFFF), bx)         );
	TEST_INST("664489bc24ffff0000"      , mov(mem16::ptr(rsp, 0xFFFF), r15w)       );
	TEST_INST("6641898effff0000"        , mov(mem16::ptr(r14, 0xFFFF), cx)         );
	TEST_INST("66418996ffff0000"        , mov(mem16::ptr(r14, 0xFFFF), dx)         );
	TEST_INST("6641899effff0000"        , mov(mem16::ptr(r14, 0xFFFF), bx)         );
	TEST_INST("664589beffff0000"        , mov(mem16::ptr(r14, 0xFFFF), r15w)       );
	TEST_INST("89c9"                    , mov(ecx, ecx)                            );
	TEST_INST("89d1"                    , mov(ecx, edx)                            );
	TEST_INST("89d9"                    , mov(ecx, ebx)                            );
	TEST_INST("4489f9"                  , mov(ecx, r15d)                           );
	TEST_INST("418b8fffff0000"          , mov(ecx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b08"                    , mov(ecx, mem32::ptr(rax, 0x0))           );
	TEST_INST("8b88ffff0000"            , mov(ecx, mem32::ptr(rax, 0xFFFF))        );
	TEST_INST("418b8fffff0000"          , mov(ecx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b88ffff0000"            , mov(ecx, mem32::ptr(rax, 0xFFFF))        );
	...
	TEST_INST("418b8fffff0000"          , mov(ecx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b8c24ffff0000"          , mov(ecx, mem32::ptr(rsp, 0xFFFF))        );
	TEST_INST("418b8effff0000"          , mov(ecx, mem32::ptr(r14, 0xFFFF))        );
	TEST_INST("8b142500000000"          , mov(edx, mem32::absolute(0x0))           );
	TEST_INST("8b1425ff000000"          , mov(edx, mem32::absolute(0xFF))          );
	TEST_INST("8b1425ffff0000"          , mov(edx, mem32::absolute(0xFFFF))        );
	...
	TEST_INST("418b97ffff0000"          , mov(edx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b10"                    , mov(edx, mem32::ptr(rax, 0x0))           );
	TEST_INST("8b90ffff0000"            , mov(edx, mem32::ptr(rax, 0xFFFF))        );
	TEST_INST("418b97ffff0000"          , mov(edx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b90ffff0000"            , mov(edx, mem32::ptr(rax, 0xFFFF))        );
	...
	TEST_INST("418b97ffff0000"          , mov(edx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b9424ffff0000"          , mov(edx, mem32::ptr(rsp, 0xFFFF))        );
	TEST_INST("418b96ffff0000"          , mov(edx, mem32::ptr(r14, 0xFFFF))        );
	TEST_INST("8b1c2500000000"          , mov(ebx, mem32::absolute(0x0))           );
	TEST_INST("8b1c25ff000000"          , mov(ebx, mem32::absolute(0xFF))          );
	TEST_INST("8b1c25ffff0000"          , mov(ebx, mem32::absolute(0xFFFF))        );
	...
	TEST_INST("418b9fffff0000"          , mov(ebx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b18"                    , mov(ebx, mem32::ptr(rax, 0x0))           );
	TEST_INST("8b98ffff0000"            , mov(ebx, mem32::ptr(rax, 0xFFFF))        );
	TEST_INST("418b9fffff0000"          , mov(ebx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b98ffff0000"            , mov(ebx, mem32::ptr(rax, 0xFFFF))        );
	...
	TEST_INST("418b9fffff0000"          , mov(ebx, mem32::ptr(r15, 0xFFFF))        );
	TEST_INST("8b9c24ffff0000"          , mov(ebx, mem32::ptr(rsp, 0xFFFF))        );
	TEST_INST("418b9effff0000"          , mov(ebx, mem32::ptr(r14, 0xFFFF))        );
	TEST_INST("448b3c2500000000"        , mov(r15d, mem32::absolute(0x0))          );
	TEST_INST("448b3c25ff000000"        , mov(r15d, mem32::absolute(0xFF))         );
	TEST_INST("448b3c25ffff0000"        , mov(r15d, mem32::absolute(0xFFFF))       );
	...
	TEST_INST("458bbfffff0000"          , mov(r15d, mem32::ptr(r15, 0xFFFF))       );
	TEST_INST("448b38"                  , mov(r15d, mem32::ptr(rax, 0x0))          );
	TEST_INST("448bb8ffff0000"          , mov(r15d, mem32::ptr(rax, 0xFFFF))       );
	TEST_INST("458bbfffff0000"          , mov(r15d, mem32::ptr(r15, 0xFFFF))       );
	TEST_INST("448bb8ffff0000"          , mov(r15d, mem32::ptr(rax, 0xFFFF))       );
	...
	TEST_INST("458bbfffff0000"          , mov(r15d, mem32::ptr(r15, 0xFFFF))       );
	TEST_INST("448bbc24ffff0000"        , mov(r15d, mem32::ptr(rsp, 0xFFFF))       );
	TEST_INST("458bbeffff0000"          , mov(r15d, mem32::ptr(r14, 0xFFFF))       );
	TEST_INST("488b0c2500000000"        , mov(rcx, mem64::absolute(0x0))           );
	TEST_INST("488b0c25ff000000"        , mov(rcx, mem64::absolute(0xFF))          );
	TEST_INST("488b0c25ffff0000"        , mov(rcx, mem64::absolute(0xFFFF))        );
	...
	TEST_INST("c604250000000000"        , mov(mem8::absolute(0x0), 0)              );
	TEST_INST("c60425000000007f"        , mov(mem8::absolute(0x0), 127)            );
	TEST_INST("c604250000000080"        , mov(mem8::absolute(0x0), -128)           );
	TEST_INST("c60425ff00000000"        , mov(mem8::absolute(0xFF), 0)             );
	TEST_INST("c60425ff0000007f"        , mov(mem8::absolute(0xFF), 127)           );
	TEST_INST("c60425ff00000080"        , mov(mem8::absolute(0xFF), -128)          );
	TEST_INST("c60425ffff000000"        , mov(mem8::absolute(0xFFFF), 0)           );
	TEST_INST("c60425ffff00007f"        , mov(mem8::absolute(0xFFFF), 127)         );
	TEST_INST("c60425ffff000080"        , mov(mem8::absolute(0xFFFF), -128)        );
	...
	TEST_INST("41c687ffff000000"        , mov(mem8::ptr(r15, 0xFFFF), 0)           );
	TEST_INST("41c687ffff00007f"        , mov(mem8::ptr(r15, 0xFFFF), 127)         );
	TEST_INST("41c687ffff000080"        , mov(mem8::ptr(r15, 0xFFFF), -128)        );
	TEST_INST("c60000"                  , mov(mem8::ptr(rax, 0x0), 0)              );
	TEST_INST("c6007f"                  , mov(mem8::ptr(rax, 0x0), 127)            );
	TEST_INST("c60080"                  , mov(mem8::ptr(rax, 0x0), -128)           );
	TEST_INST("c680ffff000000"          , mov(mem8::ptr(rax, 0xFFFF), 0)           );
	...
	TEST_INST("890c2500000000"          , mov(mem32::absolute(0x0), ecx)           );
	TEST_INST("89142500000000"          , mov(mem32::absolute(0x0), edx)           );
	TEST_INST("891c2500000000"          , mov(mem32::absolute(0x0), ebx)           );
	TEST_INST("44893c2500000000"        , mov(mem32::absolute(0x0), r15d)          );
	TEST_INST("890c25ff000000"          , mov(mem32::absolute(0xFF), ecx)          );
	TEST_INST("891425ff000000"          , mov(mem32::absolute(0xFF), edx)          );
	TEST_INST("891c25ff000000"          , mov(mem32::absolute(0xFF), ebx)          );
	TEST_INST("44893c25ff000000"        , mov(mem32::absolute(0xFF), r15d)         );
	TEST_INST("890c25ffff0000"          , mov(mem32::absolute(0xFFFF), ecx)        );
	TEST_INST("891425ffff0000"          , mov(mem32::absolute(0xFFFF), edx)        );
	TEST_INST("891c25ffff0000"          , mov(mem32::absolute(0xFFFF), ebx)        );
	TEST_INST("44893c25ffff0000"        , mov(mem32::absolute(0xFFFF), r15d)       );
	...
	TEST_INST("41898fffff0000"          , mov(mem32::ptr(r15, 0xFFFF), ecx)        );
	TEST_INST("418997ffff0000"          , mov(mem32::ptr(r15, 0xFFFF), edx)        );
	TEST_INST("41899fffff0000"          , mov(mem32::ptr(r15, 0xFFFF), ebx)        );
	TEST_INST("4589bfffff0000"          , mov(mem32::ptr(r15, 0xFFFF), r15d)       );
	TEST_INST("8908"                    , mov(mem32::ptr(rax, 0x0), ecx)           );
	TEST_INST("8910"                    , mov(mem32::ptr(rax, 0x0), edx)           );
	TEST_INST("8918"                    , mov(mem32::ptr(rax, 0x0), ebx)           );
	TEST_INST("448938"                  , mov(mem32::ptr(rax, 0x0), r15d)          );
	...
	TEST_INST("41bf7f000000"            , mov(r15, 127)                            );
	TEST_INST("49c7c780ffffff"          , mov(r15, -128)                           );
	TEST_INST("48c704250000000000000000", mov(mem64::absolute(0x0), 0)             );
	TEST_INST("48c7042500000000ffffff7f", mov(mem64::absolute(0x0), 2147483647)    );
	TEST_INST("48c704250000000000000080", mov(mem64::absolute(0x0), -2147483648)   );
	TEST_INST("48c7042500000000ff7f0000", mov(mem64::absolute(0x0), 32767)         );
	TEST_INST("48c70425000000000080ffff", mov(mem64::absolute(0x0), -32768)        );
	TEST_INST("48c70425000000007f000000", mov(mem64::absolute(0x0), 127)           );
	TEST_INST("48c704250000000080ffffff", mov(mem64::absolute(0x0), -128)          );
	TEST_INST("48c70425ff00000000000000", mov(mem64::absolute(0xFF), 0)            );
	TEST_INST("48c70425ff000000ffffff7f", mov(mem64::absolute(0xFF), 2147483647)   );
	TEST_INST("48c70425ff00000000000080", mov(mem64::absolute(0xFF), -2147483648)  );
	TEST_INST("48c70425ff000000ff7f0000", mov(mem64::absolute(0xFF), 32767)        );
	TEST_INST("48c70425ff0000000080ffff", mov(mem64::absolute(0xFF), -32768)       );
	TEST_INST("48c70425ff0000007f000000", mov(mem64::absolute(0xFF), 127)          );
	TEST_INST("48c70425ff00000080ffffff", mov(mem64::absolute(0xFF), -128)         );
	TEST_INST("48c70425ffff000000000000", mov(mem64::absolute(0xFFFF), 0)          );
	TEST_INST("48c70425ffff0000ffffff7f", mov(mem64::absolute(0xFFFF), 2147483647) );
	TEST_INST("48c70425ffff000000000080", mov(mem64::absolute(0xFFFF), -2147483648));
	TEST_INST("48c70425ffff0000ff7f0000", mov(mem64::absolute(0xFFFF), 32767)      );
	TEST_INST("48c70425ffff00000080ffff", mov(mem64::absolute(0xFFFF), -32768)     );
	TEST_INST("48c70425ffff00007f000000", mov(mem64::absolute(0xFFFF), 127)        );
	TEST_INST("48c70425ffff000080ffffff", mov(mem64::absolute(0xFFFF), -128)       );
