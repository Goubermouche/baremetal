...
void run_tests() {
	...
	TEST_INST("6683d164", ADC(cx, I16(100)));
	TEST_INST("83d164", ADC(ecx, I32(100)));
	TEST_INST("4883d164", ADC(rcx, I32(100)));
	...
	TEST_INST("6683c164", ADD(cx, I16(100)));
	TEST_INST("83c164", ADD(ecx, I32(100)));
	TEST_INST("4883c164", ADD(rcx, I32(100)));
	...
	TEST_INST("6683e164", AND(cx, I16(100)));
	TEST_INST("83e164", AND(ecx, I32(100)));
	TEST_INST("4883e164", AND(rcx, I32(100)));
	...
	TEST_INST("6683f964", CMP(cx, I16(100)));
	TEST_INST("83f964", CMP(ecx, I32(100)));
	TEST_INST("4883f964", CMP(rcx, I32(100)));
	...
	TEST_INST("66b96400", MOV(cx, I16(100)));
	TEST_INST("b964000000", MOV(ecx, I32(100)));
	TEST_INST("b964000000", MOV(rcx, I64(100)));
	TEST_INST("b964000000", MOV(rcx, I32(100)));
	...
	TEST_INST("6683c964", OR(cx, I16(100)));
	TEST_INST("83c964", OR(ecx, I32(100)));
	TEST_INST("4883c964", OR(rcx, I32(100)));
	...
	TEST_INST("6683d964", SBB(cx, I16(100)));
	TEST_INST("83d964", SBB(ecx, I32(100)));
	TEST_INST("4883d964", SBB(rcx, I32(100)));
	...
	TEST_INST("6683e964", SUB(cx, I16(100)));
	TEST_INST("83e964", SUB(ecx, I32(100)));
	TEST_INST("4883e964", SUB(rcx, I32(100)));
	...
	TEST_INST("66f7c16400", TEST(cx, I16(100)));
	TEST_INST("f7c164000000", TEST(ecx, I32(100)));
	TEST_INST("48f7c164000000", TEST(rcx, I32(100)));
	...
	TEST_INST("6683f164", XOR(cx, I16(100)));
	TEST_INST("83f164", XOR(ecx, I32(100)));
	TEST_INST("4883f164", XOR(rcx, I32(100)));
